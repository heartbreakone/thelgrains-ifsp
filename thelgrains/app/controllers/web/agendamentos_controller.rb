  ...
  class AgendamentosController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @agendamento.save
          format.html { redirect_to @agendamento, notice: 'Agendamento foi criado!' }
    ...
    private
      ...
      def agendamento_params
        params.require(:agendamento).permit(:user_id, :cliente_id, :title, :description, :start_time, :end_time, :all_day)
      end
  end
end
